...
namespace MyMedia.GestaoLoja.Migrations
{
    /// <inheritdoc />
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityModes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilityModeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_AvailabilityModes_AvailabilityModeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_AvailabilityModeId",
                table: "Products",
